	...
	<body>
		<div id="wrapper" class="animate">
			...
			<div class="container">
				...
				<form id="consulta_usuario" name="consulta_usuario" method="POST" action="get_consulta_usuario.php">
					<div class="form-group">
						<label for="busca_nome_usuario">Nome</label>
						<input type="text" class="form-control" id="busca_nome_usuario" name="busca_nome_usuario" placeholder="Nome." autofocus>
						<small id="" class="form-text text-muted">Insira um nome para pesquisar ou deixe em branco para ver todos.</small>
				    </div>
