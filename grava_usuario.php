		...
		<div id="wrapper" class="animate">
			...
			<div class="container">
				...
				<?php
					...
					$sql = "";
					if($sinal == 1){
						$sql = "insert into usuarios (nome,senha,grupo) values ('".$nome."','".$senha."','".$grupo."');";
					}else if($sinal == 2){
						$Ucod = $_POST['Ucod'];
						$sql = "update usuarios set nome = '".$nome."', senha = '".$senha."', grupo = '".$grupo."' where codigo = ".$Ucod;
					}	
						...
						if($sinal == 1){
													...
													<div class='modal-dialog' role='document'>
														<div class='modal-content'>
															...
															<div class='modal-footer'>
																<a href='cadastra_usuario.php'><button type='button' class='btn btn-success'>Ok</button></a>
															</div>
														</div>
													</div>
												</div>				
							...
							echo "<div class='modal fade' id='myModal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel'>
													<div class='modal-dialog' role='document'>
														<div class='modal-content'>
															<div class='modal-header'>
																<h4 class='modal-title' id='myModalLabel'>Usuário alterado com Sucesso!</h4>
															</div>
															<div class='modal-body'>
																Usuário - ".$nome."
															</div>
															<div class='modal-footer'>
																<a href='consulta_usuario.php'><button type='button' class='btn btn-success'>Ok</button></a>
															</div>
														</div>
													</div>
												</div>				
