<?php
	...
	@$UPcod = $_GET['id'];
	$sql = "select codigo,upper(nome),grupo,senha from usuarios where codigo = ".$UPcod;
...
<html lang="pt-br">
	...
	<body>
		<div id="wrapper" class="animate">
			...
			<div class="container">
				<div class="p-3 mb-2 text-white" id="teex"><center><h6>Edita Usuários</h6></center></div>	
				<form name="cadusu" id="cadusu" method="POST" action="grava_usuario.php">
					<div class="form-group">
						<label for="nome" class="cols-sm-2 control-label">Nome</label>
						<div class="cols-sm-10">
							<div class="input-group">
								<input type="text" class="form-control" name="nomeC" id="nomeC"  placeholder="Nome" value="<?php echo($Unome); ?>" required autofocus />
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<input type="password" class="form-control" name="senhaC" id="senhaC"  placeholder="Senha" value="<?php echo($Usenha); ?>" required />
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<input type="hidden" name="Ucod" value="<?php echo($Ucod); ?>">
					<input type="hidden" name="sinal" value="2">
					<div class="form-group ">
						<button target="_blank" type="submit" id="button" class="btn btn-secondary btn-lg btn-block login-button">Salvar</button>
					</div>
				</form>
			</div>
		</div>
